C Copyright (C) 2013 ESA, Flight Dynamics HSO-GF
      SUBROUTINE PLA422 (DAY,LIST,IPV,PV,KRUT)
C
CP  PLANETARY EPHEMERIDES DERIVED FROM JPL DE422
C
CN  N.B. USE ORBIT LIBRARY ROUTINE PLC422 FOR CONSTANTS CONSISTENT
CN       WITH THE DE422 EPHEMERIDES.
C
...
C 1799/12/16.0 = (MJD2000) -73064.0 & 2300/01/20.0 = (MJD2000) 109592.0
C ON FILE: /home/oalib/orblib/data/de422 to unit 12.
C
C THE FILE CONTAINS 5708 DATA RECORDS AND 1 HEADER RECORD, 
...
C      DATA SCCS_INFO
C     &/'@(#)/home/oalib/orblib/src/SCCS/s.pla422.f  ',
C     &' 1.1 13/02/06 ORBLIB\n'/
C
...
C      IC = NUMBER OF COEFFICIENTS FOR THE BODIES
      DATA DINT/32D0/,NREC/5709/,NPL/11/
