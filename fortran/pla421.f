      SUBROUTINE PLA421 (DAY,LIST,IPV,PV,KRUT)
C
CP  PLANETARY EPHEMERIDES DERIVED FROM JPL DE421
C
CN  N.B. USE ORBIT LIBRARY ROUTINE PLC421 FOR CONSTANTS CONSISTENT
CN       WITH THE DE421 EPHEMERIDES.
C
...
C ON FILE: /home/oalib/orblib/data/de421 to unit 12.
C
...
C     &/'@(#)/home/oalib/orblib/src/SCCS/s.pla421.f	',
