      SUBROUTINE PLA405 (DAY,LIST,IPV,PV,KRUT)
C
CP  PLANETARY EPHEMERIDES DERIVED FROM JPL DE405
C
CN  N.B. USE ORBIT LIBRARY ROUTINE PLC405 FOR CONSTANTS CONSISTENT
CN       WITH THE DE405 EPHEMERIDES.
C
...
C 1899/12/04.0 = (MJD2000) -36552.0 & 2050/01/02.0 = (MJD2000) 18264.0
C ON FILE: /home/oalib/orblib/data/de405 to unit 12.
C
...
C     &/'@(#)/home/oalib/orblib/src/SCCS/s.pla405.f	',
C     &'1.3	10/09/08 	ORBLIB\n'/
C
